...
function Account() {
  ...
  const { loginEmail, loginGoogle, loginGithub, loginFacebook, register } =
          ...
          >
            ...
            <div className="otherLoggingOptions">
              <h5 className="text-center">
                Or select one of alternative logging options:
              </h5>
              <Button
                variant="light"
                ...
                className="loginButtonStyle"
              >
                <img src="https://firebasestorage.googleapis.com/v0/b/forkit-d574f.appspot.com/o/googleIcon.svg?alt=media&token=acf1418a-c215-4ecc-87d8-e0f5e6ea051a" />{" "}
                Log in with Google
              </Button>
              ...
              >
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/forkit-d574f.appspot.com/o/github.png?alt=media&token=4f7440c9-6b84-4434-80d2-970c13a0301b"
                  width={"45px"}
                />
              ...
              >
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/forkit-d574f.appspot.com/o/facebook.png?alt=media&token=011fb176-e357-48df-a263-cb03e4ebabc6"
                  width={"45px"}
                />
