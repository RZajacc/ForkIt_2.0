    ...
    <>
      <Container className="containerStyle">
        ...
        <p className="text-center">
          <b>Health score: </b>
          <span className="nutritionStyle">{recipeData?.healthScore}</span>
          <b> Ready in (minutes): </b>{" "}
          <span className="nutritionStyle">{recipeData?.readyInMinutes}</span>
          <b> Servings: </b>{" "}
          <span className="nutritionStyle">{recipeData?.servings}</span>
          <b> Sustainable: </b>{" "}
          <span className="nutritionStyle">
            {recipeData?.sustainable ? "Yes" : "No"}
          </span>
        </p>
