    ...
    <>
      <Row className="justify-content-md-center dashboard-content" xs={10}>
        {user?.photoURL ? (
          ...
          <img
            src="https://firebasestorage.googleapis.com/v0/b/forkit-d574f.appspot.com/o/noUser.png?alt=media&token=37607a3a-371b-40a9-9947-a0005991680b"
      ...
      <Row className="dashboard-bottom-content" xs={10}>
        ...
        <p>
          <strong>Email: </strong>{" "}
          {user!.email || user?.providerData[0].email || "Data not available"}
        </p>
        <p>
